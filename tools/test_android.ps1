...
$tests = @('test_content_data','test_circuit_loading','test_motion','test_game','test_arcade','test_powerups','test_touch_hud','test_race_setup','test_circuit_layout','test_all_courses','test_storm_finish','test_mobile_lifecycle','test_transitions','test_matrix')
