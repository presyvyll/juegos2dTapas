...
func show_home() -> void:
	...
	var title := RacingUI.label("¡Que te lleve la corriente!", 34)
	content.add_child(title)
	content.add_child(RacingUI.label("Cuatro tapas. Un río. Tu próxima victoria."))
	content.add_child(RacingUI.button("JUGAR", func() -> void: get_tree().change_scene_to_file("res://levels/race.tscn")))
